...
import { MONTH_LABELS, MONTH_SHORT } from './payroll/constants';
import { sumActiveBonusesForEmployee } from './payroll/payrollBonusUtils';
import UmumiyHisobModal from './payroll/UmumiyHisobModal';
import EmployeeDetailModal from './payroll/EmployeeDetailModal';
import { TabBtn, Empty } from './payroll/PayrollChrome';
  ...
  const employeeStats = useMemo(() => {
    return employees
      ...
      .map(emp => {
        ...
        const totalBonuses = sumActiveBonusesForEmployee(bonuses, empId);
            ...
            <div className="space-y-3">
              {employeeStats.length === 0
                ...
                : employeeStats.map((stats, idx) => {
                  const { emp, empId, totalTaken, totalEarned, totalFines, totalBonuses = 0, remaining, workedDays, objNames } = stats;
